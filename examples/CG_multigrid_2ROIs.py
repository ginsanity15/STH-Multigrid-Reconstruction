...
The following is the utility script used to do multigrid reconstruction by
iterative method with TV regularization
...
Input data:
    ...
    The first Region of Interest (ROI1) defined by "insert_min_pt1" and "insert_max_pt1"
    The second Region of Interest (ROI2) defined by "insert_min_pt2" and "insert_max_pt2"
    Discretization on the coarse grid: coarse length
