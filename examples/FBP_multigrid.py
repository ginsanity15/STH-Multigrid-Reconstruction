...
filename_f = output_store_path + 'FBP' + '_coarse_space_' + str(coarse_length) + '_fine.txt'
...
# Define ROI here
insert_min_pt1 = [-5, 0, -0.5]
insert_max_pt1 = [5, 10, 0.5]
...
fbp_insert = odl.tomo.fbp_op(insert_ray_trafo1, filter_type = 'Hann', frequency_scaling = 0.1)
...
df.Display_multigrid(reco, 16, insert_min_pt1, insert_max_pt1, cell)